...
public class Transper {
	...
	private static String clientId="NUfjbV8y8bFR_v_s9zIy";
	private static String clientSecret="FnP5YNtXQn";
	...
	public static void main(String[] args) {
		...
		if(koStr.trim().length() >=20 ) {
			System.out.println("번역할 글자는 50글자 이하입니다.");
			return;
		}
		String regex = "^[ㄱ-ㅎ가-힣]*$";
